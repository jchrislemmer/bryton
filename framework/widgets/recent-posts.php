...
class seller_Recent_Posts extends WP_Widget {

	public function __construct() {
		parent::__construct(
			'seller_rp', // Base ID
			__('Seller Recent Posts with Thumbnails', 'seller'), // Name
			array( 'description' => __( 'Display your recent posts, with a Thumbnail.', 'seller' ), ) // Args
		);
	}
	...
	if (isset($instance['title'])) :
 	...
 	public function form( $instance ) {
		if ( isset( $instance[ 'title' ] ) ) {
			...
			$title = __( 'Latest Articles', 'seller' );
		}
...
add_action( 'widgets_init', 'register_seller_widget' );  
function register_seller_widget() {  
    register_widget( 'seller_Recent_Posts' );  
}  
