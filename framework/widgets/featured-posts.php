...
class seller_Featured_Posts extends WP_Widget {

	public function __construct() {
		parent::__construct(
			'seller_fp_cat', // Base ID
			__('seller Featured Posts by Category', 'seller'), // Name
			array( 'description' => __( 'Display your Featured Content, with a Thumbnail.', 'seller' ), ) // Args
		);
	}
	...
	if (isset($instance['title'])) :
 	...
 	public function form( $instance ) {
		if ( isset( $instance[ 'title' ] ) ) {
			...
			$title = __( 'Featured Articles', 'seller' );
		}
		if ( isset( $instance[ 'no_of_posts' ] ) ) {
			$no_of_posts = $instance[ 'no_of_posts' ];
		}
		else {
			$no_of_posts = __( '5', 'seller' );
		}
		...
		?>
		<p>
		<label for="<?php echo $this->get_field_id( 'title' ); ?>"><?php _e( 'Title:','seller' ); ?></label> 
		<input class="widefat" id="<?php echo $this->get_field_id( 'title' ); ?>" name="<?php echo $this->get_field_name( 'title' ); ?>" type="text" value="<?php echo esc_attr( $title ); ?>" />
		
		<label for="<?php echo $this->get_field_id( 'no_of_posts' ); ?>"><?php _e( 'No. of Posts:', 'seller' ); ?></label>
		...
		<label for="<?php echo $this->get_field_id( 'fcat' ); ?>"><?php _e( 'Category ID', 'seller' ); ?></label>
...
add_action( 'widgets_init', 'register_seller_f_widget' );  
function register_seller_f_widget() {  
    register_widget( 'seller_Featured_Posts' );  
}  
