...
<article id="post-<?php the_ID(); ?>" <?php post_class('col-md-4 col-sm-4 grid seller seller_3_column'); ?>>
		...
		<div class="out-thumb col-md-12">
			<header class="entry-header">
				...
				<div class="postedon"><?php seller_posted_on(); ?></div>
				<span class="entry-excerpt"><?php echo substr(get_the_excerpt(),0,200).(get_the_excerpt() ? "..." : "" ); ?></span>
				<span class="readmore"><a class="hvr-underline-from-center" href="<?php the_permalink() ?>"><?php _e('Read More','seller'); ?></a></span>
			</header><!-- .entry-header -->
		</div><!--.out-thumb-->
