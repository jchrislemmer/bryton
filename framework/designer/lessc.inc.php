...
class lessc {
		...
		case 'mixin':
			...
			foreach ($mixins as $mixin) {
				...
				if (isset($mixin->parent->scope)) {
					...
					$mixinParentEnv->sellerParent = $mixin->parent->scope;
				}
	...
	protected function get($name, $default=null) {
		...
		while ($current) {
			...
			if (isset($current->seller[$name]))
				return $current->seller[$name];
			else {
				$current = isset($current->sellerParent) ?
					$current->sellerParent : $current->parent;
			}
		}
