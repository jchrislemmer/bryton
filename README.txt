...
2. Upload the seller.zip file, in which you found this README.txt
3. Click on Install and Activate.
...
Seller is a relatively new theme, and could contain some hidden bugs. So, if you find any please report them at the following URL:
